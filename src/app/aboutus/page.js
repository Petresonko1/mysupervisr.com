        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                    ...
                    />
                    <div className="">
                        <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold"><span className="font-bold">Work smarter,</span> <br/> by using mysupervisr AI not  manually</h3>
                        <p className="text-slate-400 max-w-xl">Welcome to the future of academic excellence with MySupervisr! Our AI-driven platform revolutionizes the way academics write, review, and excel in their work. <br>From document analysis to feedback generation, summarization, and article recommendations, MySupervisr is your ultimate academic companion. <br> Join us to experience real-time editing suggestions, summary generation, feedback highlighting, and phraseology suggestions that will elevate your academic journey to new heights!</p>

                        <ul className="list-none text-slate-400 mt-4">
                            <li className="mb-2 flex items-center"><FiCheckCircle className="text-amber-400 h-5 w-5 me-2"/> Academic Research Solutions for Tomorrow</li>
                            <li className="mb-2 flex items-center"><FiCheckCircle className="text-amber-400 h-5 w-5 me-2"/> Our Talented & Experienced Academic Researchers</li>
                            <li className="mb-2 flex items-center"><FiCheckCircle className="text-amber-400 h-5 w-5 me-2"/> Create your academic research to achieve your goals</li>
                        </ul>
                        ...
                        <ul className="md:flex inline-block w-fit mx-auto flex-wrap justify-center text-center p-2 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                            <li role="presentation" className="inline-block md:w-1/3 w-full p-2">
                                <button className={`${activeIndex === 0 ? "text-white bg-amber-400" : " hover:text-amber-400 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800"} px-5 py-3 text-start rounded-md w-full duration-500 `} onClick={()=>setActiveIndex(0)}>
                                    ...
                                    <p className="text-sm mt-1">Mysupervisr makes it fast easy to create content for your video creations.</p>
                                </button>
                            </li>
                            <li role="presentation" className="inline-block md:w-1/3 w-full p-2">
                                <button className={`${activeIndex === 1 ? "text-white bg-amber-400" : " hover:text-amber-400 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800"} px-5 py-3 text-start rounded-md w-full duration-500 `} onClick={()=>setActiveIndex(1)}>
                                    ...
                                    <p className="text-sm mt-1">Mysupervisr makes it fast easy to create content for your research.</p>
                                </button>
                            </li>
                            <li role="presentation" className="inline-block md:w-1/3 w-full p-2">
                                <button className={`${activeIndex === 2 ? "text-white bg-amber-400" : " hover:text-amber-400 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800"} px-5 py-3 text-start rounded-md w-full duration-500 `} onClick={()=>setActiveIndex(2)} >
                                    <h5 className="text-base font-semibold">Go for the Better</h5>
                                    <p className="text-sm mt-1">Mysupervisr makes it fast easy to summarize, paraphrase, and edit content based on its suggestions.</p>
                                </button>
                            </li>
                        </ul>
