    ...
    return(
        ...
        <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-6 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">Mysupervisr makes it fast easy to create content for your academic resaerch, social media, website, and more!</p>
                </div>
