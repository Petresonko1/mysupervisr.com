                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 text-center">
                        <div className="">
                            ...
                            <p className="text-white/70 text-lg max-w-xl mx-auto">Mysupervisr makes it fast easy to create content for your blog, social media, website, and more!</p>
                ...
                <div className="container relative text-center">
                    <div className="grid grid-cols-1">
                        <div className="text-center">
                            <p className="text-gray-400">© {new Date().getFullYear()} Mysupervisr. Design with <i className="mdi mdi-heart text-orange-700"></i> by <Link href="https://Peter Isongo.in/" target="_blank" className="text-reset">Shreethemes</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
