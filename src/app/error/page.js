                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-slate-400 dark:text-white/70 max-w-xl mx-auto">Mysupervisr makes it fast easy to create content for your research, social media, website, and more!</p>
