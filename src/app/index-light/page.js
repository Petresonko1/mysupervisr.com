            ...
            <div className="container relative z-2">
                <div className="grid grid-cols-1 text-center">
                    <div className="">
                        ...
                        <p className="text-slate-400 dark:text-white/60 text-lg max-w-xl mx-auto">Unleash Your Academic Potential with MySupervisr's AI-Powered Tools for Writing and Reviewing!</p>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-6 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">Unleash Your Academic Potential with MySupervisr's AI-Powered Tools for Writing and Reviewing!</p>
                </div>
                <Pricing/>
            </div>
