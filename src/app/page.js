            ...
            <div className="container relative z-2">
                <div className="grid grid-cols-1 text-center">
                    <div className="">
                        ...
                        <p className="text-slate-400 dark:text-white/60 text-lg max-w-xl mx-auto">Mysupervisr makes it fast easy to create content for your research, social media, website, and more!</p>
